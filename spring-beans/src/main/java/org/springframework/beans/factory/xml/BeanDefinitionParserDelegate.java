...
public class BeanDefinitionParserDelegate {
	...
	/**
	 * 存储所有使用过的bean名称，以便我们可以在每个
	 * 豆元素的基础。 重复的Bean ID /名称可能不存在
	 * 相同级别的bean元素嵌套，但可以在各个级别重复
	 *
	...
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
		...
		// 解析 scope 属性  见SPR-12167。 Spring不再接受singleton="true"，因此您必须使用scope="singleton"
	 ...
	 *
	 * Parse the meta elements underneath the given element, if any. C:\Users\Admin\Documents\Hisuite\backup
	 */
